...
Tento skript se automaticky spouští při instalaci dependencí této knihovny - je tedy před samotnou instalací zajistit, aby byl zajištěn přístup k platnému tkoenu a URL adrese.
...
\begin{center}
	...
	\midrule
	\verb"widgetID" & Identifikátor widgetu\footnote{Jedinými vyžadovanými parametry jsou \texttt{boardID} spolu s \texttt{widgetID}. Zbytek parametrů je nepovinný, je ale velice pravděpodobný, že může být potřebný ke správnému vykreslení (např. parametr \texttt{params}).}. \\
	\midrule
	\verb"params" & Pole parametrů potřebné k vizualizaci grafu \footnote{Tyto parametry jsou k nalezení v aplikaci Omni Studio. Detailní postup bude v uživatelské dokumentaci.}. \\
	\midrule
