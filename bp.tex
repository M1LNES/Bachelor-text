...
Následně je třeba tuto komponenta s předanými parametry vložit do komponenty \texttt{<VisionContextProvider/>}, aby došlo ke správnému vyrenderování.
...
Ukázkový dashboard z Omni Studio je vidět na obrázku BLABLABLA ZDE DOPLNIT ID V URL ATD
...
které je dodefinovat, aby graf mohl být vykreslen. Na obrázku BLABLA vidíme, že uživatel specifikoval ... 
