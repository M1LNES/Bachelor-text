...
Při tvorbě uživatelského rozhraní byla věnována pozornost dvěma klíčovým ob-lastem - bezpečnosti a uživatelské přívětivosti. Při generování přístupových tokenů bylo dbáno na
