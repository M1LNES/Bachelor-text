...
\begin{center}
	...
	\endlastfoot
	%
	\verb"Authorization" & Řetězec \texttt{Basic} s~klientským identifikátorem a zakódovaným klientským secretem oddělený dvojtečkou v~Base64. Výsledná hodnota vypadá např. takto: "Basic Y2xpZW50X2lkOmNsaWVudF9zZWNyZXQ=."\\
	\midrule
